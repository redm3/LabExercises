...
function insertPerson(new_name, new_street, new_suburb, new_company) {
    ...
    // Add the new person to the beginning of the people array
    people.unshift(newPerson);
  
    // Print a confirmation message
    console.log(`${new_name} has been added to the people array.`);
}

insertPerson("Marco", "456 Somewhere Else St", "Auckland", "Company Four");

function addCompany(new_name, new_category, new_start, new_end) {
    // Create a new company object with the provided information
    const newCompany = {
      name: new_name,
    ...
    // Add the new company to the end of the companies array
    companies.push(newCompany);
  
    // Print a confirmation message
    console.log(`${new_name} has been added to the companies array.`);
}

addCompany("File14 Studios", "Web3", 2022, 2023);
...
function insertCompany(new_name, new_category, new_start, new_end) {
    ...
    console.log(`New company ${new_name} inserted at the beginning of the companies list.`);
}

insertCompany("New Company", "Technology", 2022, 2025);
